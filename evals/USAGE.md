...
backfill from today's files. Audio evaluations grade expected outcomes and extracted fields and record an allowlisted
remote configuration with prompt/source hashes. They do not yet capture a full replay bundle
and cannot produce this text comparison verdict.
